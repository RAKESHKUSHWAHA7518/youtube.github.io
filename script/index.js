...
let getDataOnLoad = async () => {
  ...
  // let data = await fetch(
  //      `https://youtube.googleapis.com/youtube/v3/search?part=snippet&chart=mostwatch&regionCode=IN&maxResults=50&q=undefined&key=AIzaSyDQvEF9PuhdW3JJM28VQZXQGOo84iYvd-Q`
  //   );
  
  let data = await fetch(
    `https://youtube.googleapis.com/youtube/v3/search?part=snippet&chart=mostwatch&regionCode=IN&maxResults=50&key=AIzaSyAn8h71VOzmap8ve9kxoCHqKoE_T79ADD8`
  );
